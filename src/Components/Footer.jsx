            ...
            <footer className="bg-white dark:bg-gray-900">
                <div className="container px-6 py-8 mx-auto">
                    <div className="flex flex-col items-center text-center">
                        <a href="#">
                            <h1 className="text-2xl font-medium font-roboto text-yellow-500">BeSkilleD</h1>
                        </a>

                        <div className="flex flex-wrap justify-center mt-6 -mx-4 font-roboto">
                            ...
                            <a href="#" className="mx-4 text-sm text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> My Post </a>

                            <a href="#" className="mx-4 text-sm text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> My Bid </a>
