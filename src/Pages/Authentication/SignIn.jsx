...
const SignIn = () => {
    ...
    return (
        <>
            <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl mt-10 px-10 py-10 gap-10">
                ...
                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <a href="#" className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <span onClick={() => googleLogin()} className="w-5/6 px-4 py-3 font-bold text-center">Sign in with Google</span>
                    </a>
